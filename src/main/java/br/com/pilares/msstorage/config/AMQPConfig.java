package br.com.pilares.msstorage.config;
...
public class AMQPConfig {
	...
	public Queue queueDetailsEvaluation() {
		return QueueBuilder.nonDurable("NEW_PERSON.CREATE_PATH").build();
	}
	
	@Bean
	public FanoutExchange fanoutExchange() {
		return ExchangeBuilder.fanoutExchange("NEW_PERSON").build();
	}
